    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: GestureDetector(
          ...
          child: Icon(Icons.arrow_back, color: Color(0xFF5654B4), size: 24,)
        ),
        title: Consumer<MusicProvider>(
          builder: (context, data, child) =>Text("Now Playing",
            style: TextStyle(
              color: data.purple,
              fontSize: 24
            ),
      ...
      body: Consumer<MusicProvider>(
        builder: (context, songQ, child) => Container(
          ...
          child: SingleChildScrollView(
             child: Column(
              children: [
                ...
                Center(
                    child: Text(songQ.songs[songQ.currentIndex].title, 
                      style: TextStyle(
                        fontSize: 22,
                ...
                SizedBox(
                  child: Center(
                    child: Text(songQ.songs[songQ.currentIndex].artist, 
                      style: TextStyle(
                        fontSize: 19,
                        fontWeight: FontWeight.bold
                      ),
